...
private:
	...
	void writeAddress(uint64_t _offset, util::h176 _value) { accessMemory(_offset, 22); writeMemory(_offset, _value.asBytes()); }
	...
	util::h176 readAddress(uint64_t _offset) { accessMemory(_offset, 22); return util::h176(readMemory(_offset, 22)); }
