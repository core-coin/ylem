...
struct CompilerInput
{
	CompilerInput(
		...
		std::map<std::string, solidity::util::h176> _libraryAddresses,
	...
	std::map<std::string, solidity::util::h176> libraryAddresses;
...
public:
	...
	void libraryAddresses(std::map<std::string, solidity::util::h176> _libraryAddresses)
	{
