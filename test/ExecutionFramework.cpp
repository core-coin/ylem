...
void ExecutionFramework::sendMessage(bytes const& _data, bool _isCreation, u256 const& _value)
{
	...
	if (_isCreation)
	{
		...
		message.destination = EVMHost::convertToEVMC(h176{});
	}
	else
	{
...
void ExecutionFramework::sendEther(h176 const& _addr, u256 const& _amount)
{
	m_evmcHost->newBlock();
...
h176 ExecutionFramework::account(size_t _idx)
{
	return h176(h256(u256{"0x1212121212121212121212121212120000000012"} + _idx * 0x1000), h176::AlignRight);
}

bool ExecutionFramework::addressHasCode(h176 const& _addr)
{
...
h176 ExecutionFramework::logAddress(size_t _logIdx) const
{
...
u256 ExecutionFramework::balanceAt(h176 const& _addr)
{
	return u256(EVMHost::convertFromEVMC(m_evmcHost->get_balance(EVMHost::convertToEVMC(_addr))));
}

bool ExecutionFramework::storageEmpty(h176 const& _addr)
{
